...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url()?>assets/images/borongsayiconsmall.png" type="image/png">
    ...
    <div class="pushmenu menu-home5">
        <div class="menu-push">
            ...
            <ul class="nav-home5 js-menubar">
                ...
                <li class="level1 dropdown">
                    <a class="<?php echo ($active == 'diskon'?'active-menu':'') ?>" href="<?php echo base_url('diskon') ?>">Tangerang Great Sale <span class="h-ribbon v3 e-red h-pos">Sale</span></a>
                </li>
                <li class="level1 dropdown">
