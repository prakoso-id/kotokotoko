                ...
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <div class="footer-block footer-about">
                            ...
                            <a href="<?php echo base_url(); ?>">
                                <!-- <div class="header-sub-element">
                                    ...
                                    <div class="sub-right" style="margin-top:3px;">
                                        <span style="font-size: 15px;"><b>Toko Muslimah no 1 di indonesia</b></span>
                                    </div>
                                </div> -->
                        ...
                        <ul class="footer-block-content">
                            <li>
                                <span>Copyright © 2020 Dinas INDAKOPUKM - Pemerintah Kota Tangerang</span>
                            </li>
                            <li class="address">
                        ...
                        <div class="footer-block-phone">
                            ...
                            <div class="header-sub-element">
                                ...
                                <div class="sub-right">
                                    ...
                                    <div class="phone" style="font-size: 16px;"><a href="javascript:void(0)" onclick="hubungi_wa(`+62111146288`,`Halo Admin, Saya butuh bantuan perihal..`)">08111146288</a> </div>
                                </div>
                            </div>
                        </div>
