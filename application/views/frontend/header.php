...
<div class="offcanvas-menu-overlay"></div>
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__nav__option row d-flex justify-content-end">
                            ...
                            foreach ($keranjang as $value) { ?>
                                <li class="item-cart <?php echo $value->id_produk; ?>">
                                    ...
                                    <div title="Hapus Produk dari Keranjang" class="e-del hapus-produk"
                                        data-id="<?php echo $value->id_produk; ?>" data-size="<?php echo $value->size; ?>">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="header__logo">
                        <a href="<?= base_url() ?>"><img src="<?= base_url('assets/templateFE2/') ?>img/logo.png" alt="" style="width:212px;"></a>
                    </div>
                </div>
