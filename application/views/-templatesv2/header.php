<header id="header" class="header-v5">
    ...
    <div class="topbar">
        <div class="container container-240">
            <div class="row flex">
                <div class="col-md-6 col-sm-6 flex-left">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 flex-right">
                    <div class="topbar-right">
                        <?php if ($this->user_model->is_umkm_penjual()) { ?>
                            <div class="element element-currency col-md-3 col-sm-3 col-xs-6" style="text-align: right;">
                                <a href="<?= base_url('dashboard') ?>" target="_blank" title="Akun UMKM">
                                    <img src="<?php echo base_url()?>assets/mytemplate/img/icons8-online-store-30.png" alt="" width="19px">
                                    <span>Akun UMKM</span>
                                </a>
                            </div>
                        <?php }elseif ($this->user_model->is_umkm_admin() || $this->user_model->is_umkm_verifikator()) { ?>
                            <div class="element element-currency col-md-3 col-sm-3 col-xs-6" style="text-align: right;">
                                <a href="<?= base_url('dashboard') ?>" title="Administrator">
                        ...
                        if ($this->user_model->is_umkm_user() || $this->user_model->is_umkm_penjual()) {
                            if ($this->user_model->is_umkm_user() && !$this->user_model->is_umkm_penjual()) {
                                ...
                                <div class="element element-currency col-md-3 col-sm-3 col-xs-6" style="text-align: right;">
                                    <a href="<?= base_url('customer/umkm') ?>" title="<?= $t ?>">
                                        <img src="<?php echo base_url()?>assets/mytemplate/img/icons8-online-store-30.png" alt="" width="19px">
                                        <span><?= $t ?></span>
                                    </a>
                                </div>
                            ...
                            <div class="element element-leaguage col-md-3 col-sm-3 col-xs-6" style="text-align: right;">
                ...
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6 v-center header-logo">
                    <a href="<?php echo base_url(); ?>">
                        <div class="header-sub-element">
                            ...
                            <div class="sub-right">
                                <span style="font-size: 13px;"><b>Yazer Indonesia Moslem Clothes no 1 di indonesia</b></span>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-7 col-md-7 v-center header-search hidden-xs hidden-sm">
                    <form method="get" class="searchform ajax-search" action="<?php echo base_url('list-produk') ?>" role="search">
                                                        ...
                                                        <div class="product-details">
                                                            <div class="inner-left">
                                                                ...
                                                                <div class="product-price">
                                                                    <?php echo "Rp. ".rp($value->harga); ?> <span>( x <?php echo $value->quantity; ?>)</span>
                                                                </div>
                                                            </div>
                                                        </div>
