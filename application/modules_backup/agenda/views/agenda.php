                        ...
                        foreach ($berita as $value): ?>
				            <div class="col-lg-6">
				                <div class="latest-items">
				                    <div class="latest-pic" style="background:url('<?php echo base_url('assets/images/agenda/').$value->foto; ?>')">
				                    ...
				                    <div class="latest-text">
				                        ...
				                        <h5>
				                        	<a title="<?php echo $value->judul; ?>" href="<?php echo base_url('agenda/detail/'.short($value->kode_agenda)) ?>"><?php echo readMore($value->judul,50); ?></a>
				                        </h5>
				                        <table class="table">
				                        	<tr>
				                        		<td>Tanggal</td>
				                        		<td>:</td>
				                        		<td><?php echo indonesian_date_2($value->tanggal); ?></td>
				                        	</tr>
				                        	<tr>
				                        		<td>Alamat</td>
				                        		<td>:</td>
				                        		<td><?php echo readMore($value->lokasi,50); ?></td>
				                        	</tr>
				                        	<tr>
				                        		<td>Keterangan</td>
				                        		<td>:</td>
