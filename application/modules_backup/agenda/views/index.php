<div class="product-body">
	<h2 class="product-name">Agenda</h2>
	<button type="button" class="btn btn-success button_action" onclick="refresh_page()">
	...
	<table class="table" cellpadding="0" cellspacing="0" border="0" class="display" width="100%" style="margin-bottom:20px">
		...
		<td style="border-bottom: 1px solid #ddd; ">
			<input type="text" name="filter_agenda" placeholder="Judul Agenda" required="" class="filter_agenda form-control" maxlength="20">
		</td>
		<td style="border-bottom: 1px solid #ddd; ">
