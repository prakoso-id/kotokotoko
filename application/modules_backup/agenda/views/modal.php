        ...
        <div class="modal-content">
            ...
            <form action="" id="add_tambah">
                <div class="modal-body" style="min-height: 200px !important;">
                    ...
                    <div class="position-relative row form-group">
                        <label class="col-sm-3 col-form-label" style="font-weight:600">Foto</label>
                        <div class="col-lg-9">
                    ...
                    <div class="position-relative row form-group">
                        <label class="col-sm-3 col-form-label" style="font-weight:600">Tanggal Acara</label>
                        <div class="col-lg-9">
                    ...
                    <div class="position-relative row form-group">
                        <label class="col-sm-3 col-form-label" style="font-weight:600">Lokasi Acara</label>
                        <div class="col-sm-9">
                    ...
                    <div class="position-relative row form-group">
                        <label class="col-sm-3 col-form-label" style="font-weight:600">Lokasi</label>
                        <div class="col-lg-9">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="refresh_page()" class="btn btn-danger">Tutup</button>
