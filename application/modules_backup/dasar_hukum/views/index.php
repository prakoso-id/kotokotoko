<div class="product-body">
	<h2 class="product-name">Dasar Hukum</h2>
	...
	<table class="table" cellpadding="0" cellspacing="0" border="0" class="display" width="100%" style="margin-bottom:20px">
		...
		<td style="border-bottom: 1px solid #ddd; ">
			<input type="text" name="filter_berita" placeholder="Judul Dasar Hukum" required="" class="filter_berita form-control" maxlength="20">
		</td>
		<td style="border-bottom: 1px solid #ddd; ">
