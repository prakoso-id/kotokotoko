        ...
        <div class="row izin_usaha_<?php echo $no; ?>">
            ...
            <div class="col-md-6">
                <div class="position-relative row form-group">
                    ...
                    <div class="col-lg-12">
                        <select class="form-control nama_izin_usaha<?php echo $no; ?> select2 step2" name="nama_izin_usaha[]" id="nama_izin_usaha_<?= $no ?>">
                        ...
                        <input type="hidden" name="nm_izin_usaha[]" class="step2">
            ...
            <div class="col-md-6">
                <div class="position-relative row form-group">
                    ...
                    <div class="col-lg-12">
                        <input type="text" name="no_surat[]" id="no_surat_<?= $no ?>" class="form-control step2" placeholder="Contoh : 01.004/UMKM-SM/V/2020" value="<?php echo $value['nomor_izin_usaha']; ?>">
                        <span class="help"></span>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                <div class="position-relative row form-group check_lainnya<?php echo $no; ?>" style="<?php echo ($value['nama_izin_usaha'] != 'LAINNYA'?'display: none;':'') ?>">
                    ...
                    <div class="col-lg-12">
                        <input type="text" name="nama_izin_usaha_lain[]" id="nama_izin_usaha_lain_<?= $no ?>" class="form-control step2" placeholder="Contoh : IUMK" value="<?php echo $value['nama_izin_lainnya']; ?>">
                        <span class="help"></span>
                    </div>
                </div>
            </div>
...
<div class="row izin_usaha_<?php echo $no; ?>">
    ...
    <div class="col-md-6">
        <div class="position-relative row form-group">
            <label class="col-sm-12 col-form-label" style="font-weight:600">*Nomor Surat IUMK</label>
            <div class="col-lg-12">
                <input type="text" name="no_surat[]" id="no_surat_<?= $no ?>" class="form-control step2" placeholder="Contoh : 01.004/UMKM-SM/V/2020">
                <span class="help"></span>
            </div>
        </div>
    </div>
    <div class="col-md-12">
        <div class="position-relative row form-group check_lainnya<?php echo $no; ?>" style="display: none;">
            <label class="col-sm-12 col-form-label" style="font-weight:600">*Lainnya</label>
            <div class="col-lg-12">
                <input type="text" name="nama_izin_usaha_lain[]" id="nama_izin_usaha_lain_<?= $no ?>" class="form-control step2" placeholder="Contoh : IUMK">
                <span class="help"></span>
            </div>
        </div>
    </div>
