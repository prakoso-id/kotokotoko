...
class Umkm extends MY_Controller {
	...
	public function index() {
		...
		$cek['select']	= 'id_umkm';
		$cek['table']	= 'm_umkm';
		$cek['where']	= 'username = '.$this->session->identity;
		...
		switch ($type) {
			case 'upload_umkm':
				if (!is_dir('assets/media/'.$_SESSION['identity'])) {
		            mkdir('assets/media/'.$_SESSION['identity'],0777);
		        }

				if (!is_dir('assets/media/'.$_SESSION['identity'].'/umkm')) {
		            mkdir('assets/media/'.$_SESSION['identity'].'/umkm',0777);
		        }
			...
			case 'upload_npwp':
				...
				if (!is_dir('assets/media/'.$_SESSION['identity'].'/npwp')) {
		            mkdir('assets/media/'.$_SESSION['identity'].'/npwp',0777);
		        }
			...
			case 'upload_ktp':
				...
				if (!is_dir('assets/media/'.$_SESSION['identity'].'/ktp')) {
		            mkdir('assets/media/'.$_SESSION['identity'].'/ktp',0777);
		        }
			...
			case 'upload_kk':
				...
				if (!is_dir('assets/media/'.$_SESSION['identity'].'/kk')) {
		            mkdir('assets/media/'.$_SESSION['identity'].'/kk',0777);
		        }
			...
			case 'upload_foto':
				...
				if (!is_dir('assets/media/'.$_SESSION['identity'].'/foto')) {
		            mkdir('assets/media/'.$_SESSION['identity'].'/foto',0777);
		        }
	...
	private function _validate($type){
        ...
        switch ($type) {
            case 'daftar_umkm':
               	...
               	if($this->input->post('nama_ibu',true) == '')
               	{
              ...
              //  	{
              //  		$data['inputerror'][] = 'nomor_npwp';
            		// $data['error_string'][] = 'Data harus diisi!';
            		// $data['status'] = FALSE;
              //  	}

               	if($this->input->post('kegiatan_usaha_utama',true) == ''){
               		$data['inputerror'][] = 'kegiatan_usaha_utama';
            		$data['error_string'][] = 'Data harus diisi!';
            		$data['status'] = FALSE;
               	}
                ...
                if($this->input->post('no_rekening',true) != ''){
                    if ($this->input->post('id_bank',true) == '' || $this->input->post('id_bank',true) == 0) {
               	...
               	// if($this->input->post('no_rumah',true) == '')
               	// {
               	...
               	// if($this->input->post('no_kantor',true) == '')
               	// {
               	// 	$data['inputerror'][] = 'no_kantor';
               	// 	$data['error_string'][] = 'Data Harus Diisi!';
               	// 	$data['status'] = FALSE;
               	// }
               	...
               	if($this->input->post('pegawai_laki',true) == '')
               	{
               		$data['inputerror'][] = 'pegawai_laki';
               		$data['error_string'][] = 'Data Harus Diisi!';
               		$data['status'] = FALSE;
               	}

               	if($this->input->post('pegawai_perempuan',true) == '')
               	{
               		$data['inputerror'][] = 'pegawai_perempuan';
               		$data['error_string'][] = 'Data Harus Diisi!';
               		$data['status'] = FALSE;
               	}

               	if($this->input->post('jml_pegawai',true) == '')
               	{
               		$data['inputerror'][] = 'jml_pegawai';
               		$data['error_string'][] = 'Data Harus Diisi!';
               		$data['status'] = FALSE;
               	}

               	if($this->input->post('jml_omset_sebelumnya',true) == '')
               	{
               		$data['inputerror'][] = 'jml_omset_sebelumnya';
               		$data['error_string'][] = 'Data Harus Diisi!';
               		$data['status'] = FALSE;
               	}

               	if($this->input->post('jml_omset_sekarang',true) == '')
               	{
               		$data['inputerror'][] = 'jml_omset_sekarang';
               		$data['error_string'][] = 'Data Harus Diisi!';
               		$data['status'] = FALSE;
               	}

               	if($this->input->post('jml_asset',true) == '')
               	{
               		$data['inputerror'][] = 'jml_asset';
               		$data['error_string'][] = 'Data Harus Diisi!';
               		$data['status'] = FALSE;
               	}

               	if($this->input->post('jml_modal_awal',true) == '')
               	{
               		$data['inputerror'][] = 'jml_modal_awal';
               		$data['error_string'][] = 'Data Harus Diisi!';
               		$data['status'] = FALSE;
               	}
                ...
                if(empty($this->input->post('id_kurir',true)))
                {
               	...
               	// if($this->input->post('kode_pos_rumah') == '')
               	// {
               	// 	$data['inputerror'][] = 'kode_pos_rumah';
               	// 	$data['error_string'][] = 'Data Harus Diisi!';
               	// 	$data['status'] = FALSE;
               	// }
                ...
                if ($this->input->post('no_surat',true)[0] != '') {
                    // if($this->input->post('memiliki_iumk') != 0)
                    // {
                ...
                if ($this->input->post('nama_ojol',true)) {
                    foreach ($_POST['nama_ojol'] as $key => $value) {
                    if ($key == '0') {
                            if($_POST['nama_ojol'][$key] == '0'){
                                if($this->input->post('keterangan_ojol')[$key] != '')
                                {
                                    $data['inputerror'][] = 'nm_ojol[]';
                                    $data['error_string'][] = 'Nama Ojol Harus Diisi!';
                                    $data['status'] = FALSE;
                                }
                            }else{
                                if($this->input->post('keterangan_ojol')[$key] == '')
                                {
                                    $data['inputerror'][] = 'keterangan_ojol[]';
                                    $data['error_string'][] = 'Link / Url Ojol Harus Diisi!';
                                    $data['status'] = FALSE;
                                }
                                if (filter_var($this->input->post('keterangan_ojol')[$key], FILTER_VALIDATE_URL) === FALSE) {
                                    $data['inputerror'][] = 'keterangan_ojol[]';
                                    $data['error_string'][] = 'Link / Url Ojol Tidak Valid !';
                                    $data['status'] = FALSE;
                                }
                            }
                        }else{
                            if($this->input->post('nama_ojol')[$key] == '0')
                            {
                                $data['inputerror'][] = 'nm_ojol[]';
                                $data['error_string'][] = 'Nama Ojol Harus Diisi!';
                                $data['status'] = FALSE;
                            ...
                            if($this->input->post('nama_ojol')[0] == '0')
                            {
                                $data['inputerror'][] = 'nm_ojol[]';
                                $data['error_string'][] = 'Nama Ojol Harus Diisi!';
                                $data['status'] = FALSE;
                            }
                            if($this->input->post('keterangan_ojol')[0] == '')
                            {
                                $data['inputerror'][] = 'keterangan_ojol[]';
                                $data['error_string'][] = 'Link / Url Ojol Harus Diisi!';
                                $data['status'] = FALSE;
                            }
                            if (filter_var($this->input->post('keterangan_ojol')[0], FILTER_VALIDATE_URL) === FALSE) {
                                $data['inputerror'][] = 'keterangan_ojol[]';
                                $data['error_string'][] = 'Link / Url Ojol Tidak Valid !';
                                $data['status'] = FALSE;
                            }
