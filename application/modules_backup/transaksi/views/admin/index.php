...
<div class="product-body">
	<h2 class="product-name">Daftar Transaksi</h2>
	...
	<table class="table" cellpadding="0" cellspacing="0" border="0" class="display" width="100%" style="margin-bottom:50px">
		...
		?>
		<td>
			<input type="text" name="filter_invoice" placeholder="Cari Invoice" class="filter_invoice form-control" maxlength="20">
		</td>
		<?php if($this->user_model->is_umkm_admin()){ ?>
			<td>
				<input type="text" name="filter_nama_umkm" placeholder="Cari penjual (UMKM)" class="filter_nama_umkm form-control" maxlength="20">
			</td>
		 	<td>
				<input type="text" name="filter_nama_pembeli" placeholder="Cari pembeli" class="filter_nama_pembeli form-control" maxlength="20">
			</td>
		<?php }else{
			echo '<input type="hidden" class="form-control filter_nama_umkm" name="filter_nama_umkm">
				  <input type="hidden" class="form-control filter_nama_pembeli" name="filter_nama_pembeli">';
		} ?>
		<td>
