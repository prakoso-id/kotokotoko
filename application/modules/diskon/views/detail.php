                ...
                <div class="single-flex">
                    <div class="single-product-info product-info product-grid-v2 s-50">
                        ...
                        <div class="product-price">
                            <span class="red"><?php echo "Rp. ".rp($produk->harga);?></span>
                        </div>
	                        ...
	                        <div class="profile-name" style="margin-left: -10px;">
	                        	...
	                        	<span style="float: right;margin: -20px 0px;">
	                            	...
	                            	if ($produk->no_hp || ($this->user_model->is_login() && $this->session->identity != $produk->nik)) {
										...
										if($this->user_model->is_login()){
											if($this->session->identity != $produk->nik){
												echo '<button title="Hubungi Penjual" onclick="hubungi_pesan('.$produk->id_produk.','.$produk->username.')" type="button" class="btn btn-submit" style="color: #1F3DB0;background-color: #fff;"><i class="fa fa-comments-o"></i> <font class="hidden-xs">Chat Penjual</font></button>';
											}
										}
									}
							 		?>
