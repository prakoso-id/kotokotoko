<div class="container container-240 shop-collection">
    ...
    <div class="row shop-colect">
        ...
        <div class="col-md-9 col-sm-12 col-xs-12 collection-list">
            <div class="e-product">
                <div class="pd-banner">
                   <a href="javascript:void(0);" class="image-bd effect_img2"><img src="<?php echo base_url(); ?>assets/images/banner_tgs.jpg" alt="" class="img-reponsive"></a> 
                </div>
                <div class="pd-top">
                    ...
                    <div class="row">
                        ...
                        if ($produk) {
                            foreach ($produk as $value) { 
                                echo card_produk($value,'col-xs-6 col-sm-6 col-md-4 col-lg-4', 'diskon');
                            }
                        }else{ ?>
