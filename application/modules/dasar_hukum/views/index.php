		      			...
		      			<div class="card-body">
			      			...
			      			<div class="form-row">
			      				<div class="form-group col-md-6">
					              	...
					              	<input type="text" name="filter_berita" id="filter_berita" placeholder="Judul Dasar Hukum" required="" class="filter_berita form-control" maxlength="20">
								</div>
