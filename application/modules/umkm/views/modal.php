    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body" style="min-height: 200px !important;">
                <div id="smartwizard_konfirmasi" class="smartwizard">
                    <ul class="nav">
                       <li>
                    ...
                    <div class="tab-content">
                       <div id="step-a" class="tab-pane step-1" role="tabpanel">
                            <div class="row">
                                <div class="col-md-6">
                       ...
                       <div id="step-b" class="tab-pane step-2" role="tabpanel">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="position-relative row form-group">
                       ...
                       <div id="step-c" class="tab-pane step-3" role="tabpanel">
                          <div class="row">
                                <div class="col-md-6">
                                    <div class="position-relative row form-group">
                                        <label class="col-sm-12 col-form-label" style="font-weight:600">
            ...
            <div class="modal-footer">
                ...
                <button type="button"  class="btn btn-icon icon-left btn-primary" onclick="konfirmasi()"><i class="fas fa-check"></i> Konfirmasi</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <form action="" id="add_tambah">
                <div class="modal-body" style="min-height: 200px !important;">
                    ...
                    <div class="position-relative row form-group alasan" style="display: none;">
