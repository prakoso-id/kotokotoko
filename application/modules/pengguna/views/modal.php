			...
			<form action="" id="add_tambah">
				<div class="modal-body" style="min-height: 200px !important;">
					...
					<div class="position-relative row form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="username" placeholder="NIP/NIK" class="form-control" onkeypress="return Angkasaja(event)" maxlength="20">
				...
				<div class="modal-footer">
					...
					<button type="button" onclick="simpan_data()" class="btn btn-icon icon-left btn-primary btnSave">
